...
本文件给**在 Git 仓库里浏览**的人看，内容和 zip 包里的 `SKILL_INSTALL.md` 一致。

**实际使用**：在 Vacao → **设置 → 下载 Skill 安装包**，解压后阅读 zip 根目录的 `SKILL_INSTALL.md` 并按步骤安装。

**打包来源**：`app/src-tauri/skill-bundle/`（改安装说明时请同步改 skill-bundle 与本文件）。
